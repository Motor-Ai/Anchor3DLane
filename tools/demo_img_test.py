...
def parse_args():
    ...
    parser.add_argument(
        "--config",
        default="configs/openlane/anchor3dlane.py",
        help="train config file path",
    )
    parser.add_argument("--work-dir", help="the dir to save logs and models")
    parser.add_argument("--load_from", help="the checkpoint file to load weights from")
...
def main():
    ...
    out = model(
        ...
        mask=data["mask"],
        return_loss=False,
        gt_project_matrix=data["gt_project_matrix"],
    )
